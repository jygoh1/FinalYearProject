function [ar,e,k]=lpcautomask(s,p,m,th,t)
%LPCAUTOMASK  performs autocorrelation LPC analysis [AR,E,K]=(S,P,M,T)
%  Inputs:
...
%       Modified from: lpcauto.m (VOICEBOX)
%       Modified by: Jia Ying Goh 2017
%
