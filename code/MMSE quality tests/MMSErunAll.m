function [SNRMDKFmask, SNRLPCmask, SNRNoisemask, SNRMDKF, SNRmmse, SNRbabble, ...
    ...
    stoiMDKFmask, stoiLPCmask, stoiNoisemask, stoiMDKF, stoiMMSE, stoiNoisy] = MMSErunAll(y_clean, y_babble, fs)
...
% MMSE-enhanced LPCs
% linear MDKF
y_MDKF = idealMDKF_MMSE(y_babble, y_mmse, y_mmse, fs, Tw, Ts, p_MDKF, Tw_slow, Ts_slow, fs_slow);

% uncorrelated MDKF with IBM applied in KF equations
y_MDKF_uncorrIBM = uncorrelatedMDKF_IBM_all_MMSE(y_babble, y_mmse, y_mmse, fs, Tw, Ts, p_MDKF, Tw_slow, Ts_slow, fs_slow, LC, u_present, var_present, u_absent, var_absent);

% mask-enhanced LPCs
y_maskLPC = MDKFmaskLPC_MMSE(y_babble, y_mmse, y_mmse, fs, Tw, Ts, p_MDKF, Tw_slow, Ts_slow, fs_slow, LC, maskth);

% mask-enhanced noise estimation
y_MDKF_IBMnoise = idealMDKF_noiseIBM_MMSE(y_babble, y_mmse, y_mmse, fs, Tw, Ts, p_MDKF, Tw_slow, Ts_slow, fs_slow, LC, maskth_noise);
